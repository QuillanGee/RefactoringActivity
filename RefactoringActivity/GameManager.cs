...
public class GameManager
{
    ...
    private void SolveFunction(string input)
    {
    ...
    private void UseFunction(string input)
    {
        string[] parts = input.Split(' ');
        if (parts.Length > 1)
        {
    ...
    private void TakeFunction(string input)
    {
        string[] parts = input.Split(' ');
        if (parts.Length > 1)
        {
    ...
    private void GoFunction(string input)
    {
        string[] parts = input.Split(' ');
        if (parts.Length > 1)
        {
